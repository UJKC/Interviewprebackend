...
import { type Category, insertCategoryParams } from "@/lib/db/schema/category";
import {
  createCategoryAction,
  deleteCategoryAction,
  updateCategoryAction,
} from "@/lib/actions/category";
import { TAddOptimistic } from "@/app/(app)/category/useOptimisticCategory";
...
const CategoryForm = ({
  ...
  const backpath = useBackPath("category");
